...
import goxjanskloon.j3d.material.Isotropic;
...
public class CameraTest{
    @Test public void balls() throws IOException{
        ...
        world.add(new Sphere(new Vector(-2.5,-3,0),2,new Isotropic(new ImageTexture(ImageIO.read(Objects.requireNonNull(CameraTest.class.getResourceAsStream("earth.jpg")))))));
